...
-- Left / primary: Acer display (Desktop 1)
hl.monitor({ output = "desc:Acer Technologies Acer KG271 0x8150BA1D", mode = "preferred", position = "0x0", scale = omarchy_monitor_scale })
hl.workspace_rule({ workspace = "1", monitor = "desc:Acer Technologies Acer KG271 0x8150BA1D", default = true })

-- Right / secondary: Iiyama display (Desktop 2)
...
hl.workspace_rule({ workspace = "2", monitor = "desc:Iiyama North America PL2530H 1154390701104", default = true })
